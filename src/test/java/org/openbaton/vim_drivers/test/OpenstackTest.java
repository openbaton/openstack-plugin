...
public class OpenstackTest {
  ...
  private class MyPort extends Port {
    protected MyPort(
        ...
        VIFType vifType,
        ImmutableMap<String, Object> vifDetails,
        String qosQueueId,
        String name,
        String networkId,
        Boolean adminStateUp,
        String macAddress,
        ImmutableSet<IP> fixedIps,
        String deviceId,
        String deviceOwner,
        String tenantId,
        ImmutableSet<String> securityGroups,
        ImmutableSet<AddressPair> allowedAddressPairs,
        ImmutableSet<ExtraDhcpOption> extraDhcpOptions,
        VNICType vnicType,
        String hostId,
        ImmutableMap<String, Object> profile,
  ...
  public void init() throws Exception {
    ...
    expFlavor =
        new MyFlavor(
            definedFlavor.getExtId(),
            definedFlavor.getFlavour_key(),
            new HashSet<Link>(),
            512,
            1,
            2,
    ...
    errorFlavor =
        new MyFlavor(
            "error_flavor_ext_id", "error_flavor_name", new HashSet<Link>(), 512, 1, 2, "", 1.1, 1);

    //Image
    expImage =
        new MyNovaImage(
            definedImage.getExtId(),
            definedImage.getName(),
            new HashSet<Link>(),
            new Date(),
            new Date(),
            "",
            ...
            Image.Status.ACTIVE,
            1,
            (int) definedImage.getMinDiskSpace(),
            (int) definedImage.getMinRam(),
            new ArrayList<BlockDeviceMapping>(),
            expImageResource,
            new HashMap<String, String>());
    faultyImage =
        new MyNovaImage(
            "not_existing_image_ext_id",
            "not_existing_image_name",
            new HashSet<Link>(),
            new Date(),
            new Date(),
            "",
    ...
    ImageDetails imageDetails =
        new MyImageDetails(
            ...
            definedImage.getName(),
            new HashSet<Link>(),
            ContainerFormat.fromValue(definedImage.getContainerFormat()),
            DiskFormat.fromValue(definedImage.getDiskFormat()),
            new Long(1),
            "mocked_checksum",
            definedImage.getMinDiskSpace(),
            definedImage.getMinRam(),
            "mocked_location",
            "mocked_owner",
            definedImage.getUpdated(),
            definedImage.getCreated(),
            new Date(),
            org.jclouds.openstack.glance.v1_0.domain.Image.Status.ACTIVE,
            definedImage.isPublic(),
            new HashMap<String, String>());
    ...
    expServer =
        new MyServer(
            definedServer.getExtId(),
            definedServer.getName(),
            new HashSet<Link>(),
            definedServer.getExtId(),
            "mocked_tenant_id",
            "",
            definedServer.getUpdated(),
            definedServer.getCreated(),
            "",
            "mocked_ip4",
            "mocked_ip6",
            org.jclouds.openstack.nova.v2_0.domain.Server.Status.fromValue(
                definedServer.getStatus()),
            expImage,
            expFlavor,
            "",
            "",
            ...
            new HashMap<String, String>(),
            extStatus,
            mock(ServerExtendedAttributes.class),
            "",
            "");
    faultyServer =
        new MyServer(
            "faulty_server_mocked_ext_id",
            "faulty_server",
            new HashSet<Link>(),
            definedServer.getExtId(),
            "mocked_tenant_id",
            ...
            "mocked_ip4",
            "mocked_ip6",
            org.jclouds.openstack.nova.v2_0.domain.Server.Status.ERROR,
            faultyImage,
            faultyFlavor,
            "",
            "",
    ...
    List<org.jclouds.openstack.nova.v2_0.domain.Server> serServerArray =
        new ArrayList<org.jclouds.openstack.nova.v2_0.domain.Server>();
    serServerArray.add(expServer);
    //serServerArray.add(faultyServer);
    //serServerArray.add(errorServer);
    FluentIterable<org.jclouds.openstack.nova.v2_0.domain.Server> serServerFI =
        FluentIterable.from(serServerArray);
    ...
    expPort =
        new MyPort(
            ...
            VIFType._802_QBG,
            ImmutableMap.copyOf(new HashMap<String, Object>()),
            "mocked_qos_queue_id",
            "mocked_name",
            "mocked_network_ext_id",
            true,
            "mocked_mac_address",
            ImmutableSet.copyOf(new HashSet<IP>()),
            "mocked_device_id",
            "mocked_device_owner",
            "mocked_tenant_id",
            ImmutableSet.copyOf(new HashSet<String>()),
            ImmutableSet.copyOf(new HashSet<AddressPair>()),
            ImmutableSet.copyOf(new HashSet<ExtraDhcpOption>()),
            VNICType.NORMAL,
            "mocked_host_id",
            ImmutableMap.copyOf(new HashMap<String, Object>()),
            false,
    ...
    expFlavorResource =
        new MyResource(
            definedFlavor.getExtId(), definedFlavor.getFlavour_key(), new HashSet<Link>());
    ...
    expImageResource =
        new MyGlanceImage(
            ...
            definedImage.getName(),
            new HashSet<Link>(),
            ContainerFormat.valueOf(definedImage.getContainerFormat()),
            DiskFormat.fromValue(definedImage.getDiskFormat()),
            (long) 1000,
            "");
    List<org.jclouds.openstack.glance.v1_0.domain.Image> resImageArray =
        new ArrayList<org.jclouds.openstack.glance.v1_0.domain.Image>();
    resImageArray.add(expImageResource);
    FluentIterable<org.jclouds.openstack.glance.v1_0.domain.Image> resImageFI =
        FluentIterable.from(resImageArray);

    expServerResource =
        new MyResource(definedServer.getExtId(), definedServer.getName(), new HashSet<Link>());
    ...
    //FloatingIP
    expFreeFloatingIP =
        new MyFloatingIP("mocked_ext_id", "mocked_free_ip", "mocked_fixed_ip", null, "mocked_pool");
    expUsedFloatingIP =
        new MyFloatingIP(
            "mocked_ext_id",
            "mocked_used_ip",
    ...
    expQuota =
        new MyQuota(
            definedQuota.getTenant(),
            10,
            10,
            10,
            10,
            definedQuota.getRam(),
            definedQuota.getFloatingIps(),
            definedQuota.getInstances(),
            10,
            definedQuota.getCores(),
            10,
            10,
    ...
    when(
            serverApi.create(
                eq(definedServer.getName()),
                anyString(),
                anyString(),
                any(CreateServerOptions.class)))
        .thenReturn(serverCreated);
    when(
            serverApi.create(
                eq("faulty_server"), anyString(), anyString(), any(CreateServerOptions.class)))
        .thenThrow(new AuthorizationException());
    when(
            serverApi.create(
                eq("faulty_server"),
                eq(faultyImage.getId()),
                eq(faultyFlavor.getId()),
                any(CreateServerOptions.class)))
        .thenReturn(faultyServerCreated);
    when(
            serverApi.create(
                eq("error_server"), anyString(), anyString(), any(CreateServerOptions.class)))
        .thenReturn(errorServerCreated);
    ...
    doThrow(new NullPointerException("triggered NullPointerException"))
        .when(serverApi)
        .reboot("not_existing_ext_id", RebootType.SOFT);

    //ImageApi
    org.jclouds.openstack.nova.v2_0.features.ImageApi novaImageApi =
        mock(org.jclouds.openstack.nova.v2_0.features.ImageApi.class);
    ...
    when(
            imageApi.create(
                eq(definedImage.getName()), any(Payload.class), any(CreateImageOptions.class)))
        .thenReturn(imageDetails);
    when(
            imageApi.create(
                eq("mocked_error_ext_image_id"), any(Payload.class), any(CreateImageOptions.class)))
        .thenThrow(new AuthorizationException());
    when(imageApi.reserve(eq(definedImage.getName()), any(CreateImageOptions.class)))
        .thenReturn(imageDetails);
    when(imageApi.reserve(eq("mocked_error_ext_image_id"), any(CreateImageOptions.class)))
        .thenThrow(new AuthorizationException());
    when(imageApi.update(eq(definedImage.getExtId()), any(UpdateImageOptions.class)))
        .thenReturn(imageDetails);
    when(imageApi.update(eq("mocked_error_ext_image_id"), any(UpdateImageOptions.class)))
        .thenThrow(new AuthorizationException());
    ...
    final org.jclouds.openstack.neutron.v2.domain.Network network =
        mock(org.jclouds.openstack.neutron.v2.domain.Network.class);
    final org.jclouds.openstack.neutron.v2.domain.Network otherNetwork =
        mock(org.jclouds.openstack.neutron.v2.domain.Network.class);
    final org.jclouds.openstack.neutron.v2.domain.Network publicNetwork =
        mock(org.jclouds.openstack.neutron.v2.domain.Network.class);
    when(
            networkApi.create(
                any(org.jclouds.openstack.neutron.v2.domain.Network.CreateNetwork.class)))
        .thenReturn(network);

    when(
            networkApi.update(
                eq(definedNetwork.getExtId()),
                any(org.jclouds.openstack.neutron.v2.domain.Network.UpdateNetwork.class)))
        .thenReturn((network));
    when(
            networkApi.update(
                eq("error_network_ext_id"),
                any(org.jclouds.openstack.neutron.v2.domain.Network.UpdateNetwork.class)))
        .thenThrow(new AuthorizationException());
    ...
    when(networkApi.list().concat())
        .thenReturn(
            FluentIterable.from(
                new ArrayList<org.jclouds.openstack.neutron.v2.domain.Network>() {
                  {
                    add(network);
                    add(otherNetwork);
                    add(publicNetwork);
    ...
    org.jclouds.openstack.neutron.v2.domain.Subnet subnet =
        mock(org.jclouds.openstack.neutron.v2.domain.Subnet.class);
    when(subnetApi.create(any(org.jclouds.openstack.neutron.v2.domain.Subnet.CreateSubnet.class)))
        .thenReturn(subnet);
    when(
            subnetApi.update(
                eq(definedSubnet.getExtId()),
                any(org.jclouds.openstack.neutron.v2.domain.Subnet.UpdateSubnet.class)))
        .thenReturn((subnet));
    when(
            subnetApi.update(
                eq("error_subnet_ext_id"),
                any(org.jclouds.openstack.neutron.v2.domain.Subnet.UpdateSubnet.class)))
        .thenThrow(new AuthorizationException());
    ...
    org.jclouds.openstack.keystone.v2_0.domain.Endpoint endpoint =
        mock(org.jclouds.openstack.keystone.v2_0.domain.Endpoint.class);
  ...
  public void testLaunchInstance() throws VimDriverException {
    Server server =
        openstackClient.launchInstance(
            vimInstance,
            definedServer.getName(),
  ...
  public void testLauchInstanceAndWait() throws Exception {
    Server server =
        openstackClient.launchInstanceAndWait(
            vimInstance,
            definedServer.getName(),
            definedServer.getImage().getExtId(),
            definedServer.getFlavor().getExtId(),
    ...
    PowerMockito.doThrow(new InterruptedException("tirggered InterruptedException"))
        .when(Thread.class);
  ...
  public void deleteServerByIdAndWait() throws Exception {
    ...
    PowerMockito.doThrow(new InterruptedException("tirggered InterruptedException"))
        .when(Thread.class, "sleep", (long) 1000);
  ...
  public void testAddImage() throws VimDriverException {
    NFVImage image =
        openstackClient.addImage(vimInstance, definedImage, "mocked_inputstream".getBytes());
  ...
  public void testGetSubnetsExtIds() throws VimDriverException {
    try {
      List<String> subnetExtIds =
          openstackClient.getSubnetsExtIds(vimInstance, definedNetwork.getExtId());
  ...
  public void testCreateSubnet() throws VimDriverException {
    ...
    try {
      when(org.jclouds.openstack.neutron.v2.domain.Subnet.CreateSubnet.class)
          .thenThrow(new AuthorizationException());
  ...
  public void testGetQuota() throws Exception {
    ...
    String response =
        "{quota_set:{cores:"
            + quota_expected.getCores()
            + "; ram:"
            + quota_expected.getRam()
            + "; instances:"
            + quota_expected.getInstances()
            + "; floating_ips:"
            + quota_expected.getFloatingIps()
            + "; key_pairs:"
            + quota_expected.getKeyPairs()
            + "}}";
    InputStream is = new ByteArrayInputStream(response.getBytes());
    when(connection.getInputStream()).thenReturn(is);
  ...
  private void assertEqualsFlavors(
      DeploymentFlavour expectedFlavor, DeploymentFlavour actualFlavor) {
